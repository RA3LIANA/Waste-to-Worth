...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Waste to Worth</p> -->
            <p  class ="logo" >Waste to <b style="color: #06C167; ">Worth</b></p>
             <p class="user"></p>
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"cuttack\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $cuttack=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"kendujhar\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $kendujhar=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"khordha\"";
...
var xplace=["Cuttack","Kendujhar","Khordha"];
var yplace=[<?php echo json_encode($cuttack,JSON_HEX_TAG);?>,<?php echo json_encode($kendujhar,JSON_HEX_TAG);?>,<?php echo json_encode($khordha,JSON_HEX_TAG);?>];
