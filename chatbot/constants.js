...
const prompts = [
  ...
  const replies = [
    ...
    ["I was made by a team of 6 members: Adyasha, Tooba, Anushka, Komal, Kanan and Sneha"],
    ["I am chitti"],
    ...
    ["Haha!","Good one!"],
    ["The basic concept of this project Waste to Worth is to collect the excess/leftover food from donors such as hotels, restaurants, marriage halls, etc and distribute to  the  needy people"],
    [currentdate],
    [time],
